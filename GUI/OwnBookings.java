...
public class OwnBookings {
     ...
     public void setTable()
    {
           ...
           // table colomn names 
            String y[]={"id","Title","Description","Time","Date","Organization/Location","Place","eid"}; 
         ...
         final JPopupMenu popupMenu = new JPopupMenu();
          ...
          view.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                bv.dtitle.setText(title);
                bv.ddesc.setText(desc);
              
                bv.dorgan.setText(organ);
                bv.dplace.setText(place);
                bv.dtime.setText(time);
                bv.ddate.setText(date);
          ...
          cancelBook.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // getting values of the selected row
                    String id = (String)table.getModel().getValueAt(selectedRow,0 );
                    String eid = (String)table.getModel().getValueAt(selectedRow,7 );
    ...
    public void initGUI()
    {
       ...
       frame.getContentPane().setBackground(Color.black);
        ...
        back = new JButton("Organizer Panel");
