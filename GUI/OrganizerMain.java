...
public class OrganizerMain {
    ...
    public JButton ownBookings;
    public JButton ownEvents;
    public JButton post;
    public Database db;
    ...
    public void getHnd(Handler h, Database dbase,StudentEventView eev,OrganizerEventView oevv)
    {
        hnd=h;
        db=dbase;
        oev=oevv;
         ...
         final JPopupMenu popupMenu = new JPopupMenu();
          ...
          view.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                oev.dtitle.setText(title);
                oev.ddesc.setText(desc);
                oev.dtype.setText(type);
                oev.dorgan.setText(organ);
                oev.dplace.setText(place);
                oev.dtime.setText(time);
                oev.ddate.setText(date);
                oev.drep.setText(rep);
                
                frame.setVisible(false);
                oev.frame.setVisible(true);
    ...
    public void initGUI()
    {
         frame = new JFrame("Organizer Panel");
       frame.getContentPane().setBackground(Color.black);
        ...
        ownBookings = new JButton("Own Bookings");
        ownBookings.setBounds(130, 480, 140, 30);
        frame.add(ownBookings);
        
         ownEvents = new JButton("Own Events");
        ownEvents.setBounds(290, 480, 140, 30);
        frame.add(ownEvents);
        
         post = new JButton("Post Event");
        post.setBounds(450, 480, 140, 30);
        frame.add(post);
        
         logout = new JButton("Logout Organizer");
