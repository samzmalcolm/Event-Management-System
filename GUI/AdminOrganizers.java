...
public class AdminOrganizers {
     ...
     public void setTable()
    {
        ...
        tcm.getColumn(2).setCellRenderer( centerRenderer );
         ...
         // init popup menu 
          ...
          JMenuItem makeOrganizer = new JMenuItem("   Demote Organizer                            ");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                   ...
                   model.removeRow(selectedRow);
                    ...
                    JOptionPane.showMessageDialog(frame, "This User is Demoted from Organizer");
                }
    ...
    public void initGUI()
    {
        ...
        JLabel l1= new JLabel("All Organizers ");
        ...
        back = new JButton("Return to Admin");
